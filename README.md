...
* [rocksdb+safepoint base image](https://app.box.com/s/9mflxilr46wybqxwlivm1xfeojrmrimi)
* [l3 image](https://app.box.com/s/p53t5p5wuh9q2l1ygfmi160fg1yqf7da)
* [accelerator+overhead image](https://app.box.com/s/n1jtptfctpc2ov1o2smcwjk6d322bvw2)

Here is how you can download the archives:
```
curl -L https://app.box.com/shared/static/n1jtptfctpc2ov1o2smcwjk6d322bvw2.gz --output ubuntu-accel-overhead.tar.gz
```
```
curl -L https://app.box.com/shared/static/p53t5p5wuh9q2l1ygfmi160fg1yqf7da.gz --output ubuntu-l3.tar.gz
```
```
curl -L https://app.box.com/shared/static/9mflxilr46wybqxwlivm1xfeojrmrimi.tar --output ubuntu7.tar
```
